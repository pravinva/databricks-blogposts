...
GRANT USE CATALOG ON CATALOG pension_blog TO `account users`;
GRANT USE SCHEMA ON CATALOG pension_blog TO `account users`;
GRANT ALL PRIVILEGES ON CATALOG pension_blog TO `57e7dc57-63b9-4114-a2ad-0a6226794a22`;
