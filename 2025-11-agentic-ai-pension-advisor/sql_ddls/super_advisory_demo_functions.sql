...
CREATE OR REPLACE FUNCTION pension_blog.pension_advisory.in_calculate_nps_benefits(
    ...
    member_age INT,
    nps_corpus DOUBLE,
    annuity_purchase_pct DOUBLE,
    monthly_pension_rate DOUBLE
)
...
-- ============================================================================
-- NOTE: Permissions are handled in the setup notebook
--
-- These GRANT statements provide EXECUTE permission to all account users.
-- You can customize these grants based on your security requirements:
-- - Change `account users` to a specific group name
-- - Add additional GRANT statements for service principals
-- - Modify permissions (EXECUTE, ALL PRIVILEGES, MANAGE)
--
