...
from src.tools import SuperAdvisorTools
...
from src.react_loop import ReactAgenticLoop, AgentState
from src.agents.context_formatter import get_context_formatter
from src.agents.response_builder import get_response_builder
...
class SuperAdvisorAgent:
    ...
    def get_citations_for_tools(self, country, tools_used):
        ...
        try:
            ...
            query_parts.append("FROM {UNITY_CATALOG}.{UNITY_SCHEMA}.citation_registry")
